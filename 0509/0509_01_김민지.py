...
print("문자열 인덱스 0번제부터 12번지 사이에 'a'가 몇 개?", text10.count('a', 0, 12))
...
print("문자열 내의 '1'을 오른쪽부터 검색하면?", text10.rindex('l'))
print("문자열 내의 '1'을 오른쪽부터 검색하면?", text10.rfind('l'))
