...
phone_book1['김민지'] = value = '010-1234-5678'
print("phone_book1 :", phone_book1)

# 딕셔너리에 값 저장 -> 2) {key : value}
phone_book2 = {'김민지':'010-1234-5678', '홍길동' : '010-2345-6789'}
...
# 5명의 이름과 전화번호 저장.
phone_book3['김민지'] = value = '010-1234-5678'
phone_book3['가나다'] = value = '010-2345-6789'
phone_book3['라마바'] = value = '010-3456-7891'
phone_book3['사아자'] = value = '010-4567-8912'
phone_book3['차카타'] = value = '010-5678-9123'
...
person_dict = {'name':'김민지', 'age':20, 'class':'1학년'}
